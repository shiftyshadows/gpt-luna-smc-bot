#!/usr/bin/env python3
"""
   This module defines the class: ClosePositionRequest
   that normalizes the json output for the ctrader json message request
   for closing or partially closing of an existing position.
"""
...
class ClosePositionRequest(OpenAPIMessage):
    """
