#!/usr/bin/env python3
"""
   This module defines the class: SubscribeSpot that normalizes
   the json output for the ctrader json message request for current
   price of an asset.
"""
...
class SubscribeLiveTrendbarsRequest(OpenAPIMessage):
    """
       This class represents a current price for a given symbol.
    """
    def __init__(self, ctidTraderAccountId: int, symbolId: int, period: int = 1, clientMsgId: str = str(uuid.uuid4())):
        """
           Initializes a `SubscribeSpot` instance.
        """

        self.payloadType = 2135
