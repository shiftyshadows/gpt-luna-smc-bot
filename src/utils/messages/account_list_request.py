#!/usr/bin/env python3
"""
   This module defines the class: AccountListRequest
...
class AccountListRequest(OpenAPIMessage):
    """
       This class represents a current price for a given symbol.
    """
    def __init__(self, accessToken: str, clientMsgId: str = str(uuid.uuid4())):
        """
           Initializes a `AssetClassList` instance.
        """

        self.payloadType = 2149
