...
class SubscribeSpotRequest(OpenAPIMessage):
    """
    ...
    def payload(self) -> dict:
        ...
        return {
            ...
            "subscribeToSpotTimestamp": self.subscribeToSpotTimestamp
        }
