#!/usr/bin/env python3
"""
   This module defines the class: UnSubscribeDepthRequest that normalizes
   the json output for the ctrader json message request for unsubscribing
   for depth events.
"""
...
class UnSubscribeDepthRequest(OpenAPIMessage):
    """
    ...
    def __init__(self, ctidTraderAccountId: int, symbolId: int, clientMsgId: str = str(uuid.uuid4())):
        """
           Initializes a `SubscribeDepth instance.
        """

        self.payloadType = 2158
