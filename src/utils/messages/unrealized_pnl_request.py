#!/usr/bin/env python3
"""
   This module defines the class: GetPositionUnrealizedPnLRequest
   that normalizes the json output for the ctrader json message request
   for getting trader's positions' unrealized PnLs.
"""
...
class GetPositionUnrealizedPnLRequest(OpenAPIMessage):
    """
